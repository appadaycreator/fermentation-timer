...
const SVC_URL = "https://appadaycreator.com/fermentation-timer/";
const SVC_NAME = "発酵・漬け物タイマー";

test.describe("発酵・漬け物タイマー - E2Eテスト", () => {
  ...
  test("ページ基本: タイトル・h1・canonical", async ({ page }) => {
    ...
    expect(canonical).toContain("fermentation-timer");
